...
RSpec.describe FundUser do
  before do
    @user = create(:user)
    # @user.confirm
    @account = @user.accounts.create(value: 10_000, name: 'account1')
    @account_for_card =
      @user.accounts.create(value: 10_000, name: 'account_for_card')
    @card =
      @user.cards.create(
        name: 'card1',
        pay_date: 10,
    ...
    @fund_with_value = Fund.create(name: 'fund1', value: 10_000)
    @fund_no_value = Fund.create(name: 'fund2')
    @fund_user1 =
      @user.fund_users.create(
    ...
    @fund_user_history1_1 =
      @fund_user1.fund_user_histories.create(
        buy_or_sell: true,
        commission: 100,
        date: Date.today,
        buy_date: Date.today,
    ...
    @fund_user_history2_1 =
      @fund_user2.fund_user_histories.create(
        buy_or_sell: true,
        commission: 100,
        date: Date.today,
        buy_date: Date.today,
